...
\begin{table}[!h]
  \caption{Distribution of work: Jan Martin WIP!}
  \centering
  \begin{tabular}{p{2cm}||p{4.2cm}|p{4cm}|l|}
    Name & Responsibilities & Principal Artefacts & Work Time\\
    \hline
    \hline
    Jan & Identify user stories & User story cards & 5 \\
    \hline
    Jan & Documentation of Controller class & Javadoc in controller & 6 \\ 
    \hline    
    Jan & Bugfixing/refactor of Controller class & fixed methods in controller & 2 \\ 
    \hline  
    Jan & Author of chapter 4.4 & Chapter in project report & 3 \\ 
    \hline
    Jan & Co-Author of chapter 4.5 & Chapter in project report & 12 \\
    \hline 
    Jan & Author of chapter 4.6 & Chapter in project report & 10 \\ 
    \hline
    Jan & Author of chapter 5 & Chapter in project report & 10 \\ 
    \hline
    \hline 
