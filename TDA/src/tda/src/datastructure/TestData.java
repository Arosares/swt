...
import tda.src.logic.analyzer.Analyzer;
import tda.src.logic.analyzer.AprioriAnalyzer;

/**
 * Our Data structure class (SINGLETON)
 * 	Stores the testruns in a List
 * 	Stores all tested Classes in a tree structure
 * 	Stores all unit Tests in a List
 *
 */
